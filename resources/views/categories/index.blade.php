...
<section class="section section--bg" data-bg="{{ URL::asset('img/section/section.jpg') }}">
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div class="card">
                    <div class="card__cover">
                        ...
                        <a href="http://127.0.0.1:8000/pages/player" class="card__play">
                            <i class="icon ion-ios-play"></i>
                        </a>
                    </div>
                    <div class="card__content">
                        <h3 class="card__title"><a href="http://127.0.0.1:8000/pages/player">{{ $title->name }}</a></h3>
            ...
            <!-- section btn -->
            <div class="col-12">
                <a href="http://127.0.0.1:8000/pages/player" class="section__btn">Show more</a>
            </div>
            <!-- end section btn -->
        </div>
    </div>
