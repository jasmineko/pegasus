...
CREATE TABLE `titles` (
  ...
  `genre` set('comedy','action','horror','sci-fi','supernatural','adventure','romance','drama') COLLATE utf8mb4_unicode_ci NOT NULL,
...
('the_amazing_world_of_gumball', 'The Amazing World of Gumball', 'img/cartoons/cartoon.jpg', 'cartoon', 'comedy,adventure', '2008-05-08', 'finished', 'UK US Japan Ireland Germany', 'Welcome to Elmore. This quaint little suburb isn\'t quite what it seems, as in Elmore, just about everything has the ability to come to life. The Amazing World of Gumball follows the misadventures of Gumball, a twelve-year-old cat. With the help of his best friend Darwin, his former pet goldfish that grew legs and joined the family, he gets into all sorts of antics. He is joined by his sister, Anais, a four-year-old bunny with heightened intelligence. His father, Richard, and his mother, Nicole, are there to provide him support as well.', 8.2),
